...
и 80% доверительный интервал `[tmin,tmax]`. N было подобрано
...
![Graphic1000.png](Graphic1000.png) 
**Скорость работы алгоритмов на 4 набора (1000 запусков)**

По оси Y отложено время выполнения в миллисекундах и 80% доверительный интервал.
